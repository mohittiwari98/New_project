...
import { FaTint, FaCheck, FaTimes, FaSearch } from 'react-icons/fa';
    ...
    <div className="space-y-6">
      ...
      >
        <div 
          ...
          className={`bg-white rounded-xl p-4 shadow-lg cursor-pointer transition-all ${filter === 'all' ? 'ring-2 ring-red-500' : ''}`}
        >
